import { boolean, pgTable, serial, varchar, text, char, timestamp, date, index, integer, point} from "drizzle-orm/pg-core";
...
export const incidentUpdates = pgTable('incident_updates', {
    ...
    incidentId: integer('incident_id').notNull().references(() => incidents.id, { onDelete: 'cascade', onUpdate: 'cascade' }),
