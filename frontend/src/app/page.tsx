        ...
        <Card className="w-full max-w-lg bg-gray-800 border-gray-700">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Button asChild variant="outline" className="w-full border-gray-600 text-gray-900 hover:bg-gray-700">
          ...
          <CardFooter>
            <p className="text-xs text-center text-gray-400 w-full">
              This is an official website. Unauthorized use is prohibited and may be subject to prosecution under Title 18, United States Code, Section 1030.
            </p>
          </CardFooter>
        </Card>
